...
import { services, storyProjects } from "@/lib/data";
...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/packages`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.85 },
  ...
  const storyPages: MetadataRoute.Sitemap = storyProjects.map((story) => ({
  ...
  return [...staticPages, ...servicePages, ...storyPages];
}
